...
resources:
  - label: Quick Start Guide
    url: "app_notes/BGA244 Quick Start Guide.pdf"
  - label: BGAMon Software
    url: "app_notes/BGAMonInstaller.exe"
  - label: BGA244 Step File (3D model)
    url: "app_notes/3DBGA244.zip"
  - label: BGA244HP Step File (3D model)
    url: "app_notes/3DBGA244HP.zip"
  - label: BGA244E Step File (3D model)
    url: "app_notes/3DBGA244E.zip"
  - label: Volatility Statement
    url: "app_notes/Volatility Statement BGA244.pdf"
  - label: BGA244 3D Animation
    url: "app_notes/BGA Explode Animation.mkv"
